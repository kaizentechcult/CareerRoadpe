  ...
  return (
    <div className="flex justify-center  flex-col">
      ...
      {data.map((articleData,index) => (
        <Link to={`${index}`} className="flex flex-col card-shadow bg-[#212020] py-4 px-8 rounded-xl justify-center items-center w-full" key={articleData.id}>  {/* Add key for each article */}
